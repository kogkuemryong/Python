...
# print(int(user1)+ 10)   # 입력 받는 값을 int로 감싸자.
...
#fruit = ["사과", "포도", "홍시"]
#answer = input('좋아하는 과일은 무엇인가요? ')
#if answer in fruit: # 포함 되어 있는지 확인 = in
#    print("정답입니다.")
#else:
#    print("오답입니다.")
...
#answer = input('투자하고 계신 종목은 무엇인가요? ')
