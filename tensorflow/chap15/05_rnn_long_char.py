...
#print(char_set) # ['b', 'e', 'n', 'h', 'k', "'", '.', 'l', ',', ' ',
#                   's', 't', 'd', 'p', 'o', 'i', 'r', 'c', 'g', 'u',
#                   'w', 'y', 'f', 'a', 'm']
char_dic = {w: i for i, w in enumerate(char_set)}

data_dim = len(char_set) # len(char_set) = 25
...
#                                                state_is_tuple=True)
multi_cells = rnn.MultiRNNCell([lstm_cell()] * 2,
                                                state_is_tuple=True)
...
for i in range(500):
    _, loss_val, results = sess.run([train_op, mean_loss, outputs],
